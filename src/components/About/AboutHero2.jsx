                      ...
                      <div className="col-lg-6">
                        <div className="about-left pos-rel">
                          ...
                          <p>
                            ...
                            elit, sed doklyeiusm tempor incididunt ut labore
                            etry of the siely.
                          </p>
                          <p>
                            Rorem ipsum dolor sit amet, consectetur adipisicing
                          ...
                          <ul className="about-info mt-30 mb-30">
                            <li>
                              <div className="about-info-title">
                                ...
                                <h5>
                                  Quisque Placereat Mnetur Fermnatu nussey
                                </h5>
                              </div>
                            </li>
                            <li>
                          ...
                          <div className="about-btn pt-20">
                            <Link to="service-details.html" className="thm-btn">
                              Learn More
                            </Link>
                            <Link to="about.html" className="about-l-btn">

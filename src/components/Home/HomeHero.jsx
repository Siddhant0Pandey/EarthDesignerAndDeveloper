                ...
                <div className="row">
                  <div className="col-xl-7 col-lg-8">
                    <div className="slider-content">
                      ...
                      <p>
                        We are a dedicated team of civil engineers, designers,
                        and developers with over 10 years of experience
                        delivering high-quality construction projects. Whether
                        you're building your dream home, an office, or an entire
                        community, we handle every detail to ensure lasting
                        results.
                      </p>
